...
public class ExpressionParser implements NodeParser<ExpressionNode> {
    ...
    private final List<LogicalOpParser> logicalParser = Arrays.asList(new LogicalOpParser(TokenType.DOUBLE_EQUALS), new LogicalOpParser(TokenType.NOT_EQUALS));
    private final List<LogicalOpParser> comparisonParsers = Arrays.asList(
